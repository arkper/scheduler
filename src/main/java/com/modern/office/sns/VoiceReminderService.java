...
public class VoiceReminderService {
    ...
    public void processNotifications() {
        ...
        StreamSupport.stream(this.schedulerApiService.getAppointmentToConfirm(0, 0, 0).spliterator(), false).filter(appt -> appt.getApptPhone() != null).forEach(appt -> this.processNotification(appt));
