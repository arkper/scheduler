...
public class PdfEditor {
	...
	void test() throws Exception
	{
		...
		strategy2.add(new RegexBasedCleanupStrategy("consent to such care including diagnostic and therapeutic procedures and medical treatment to be provided")
				.setRedactionColor(null));
